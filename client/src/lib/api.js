...
const tasks = {
  ...
  aiWorkspace: (projectId) => get(`/tasks/${projectId}/ai-workspace`),
  saveAIWorkspace: (projectId, data) => put(`/tasks/${projectId}/ai-workspace`, data),
  planPreview: (projectId, guidance) => post(`/tasks/${projectId}/ai-plan`, { guidance }),
  acceptPlan: (projectId, tasks) => post(`/tasks/${projectId}/ai-plan/accept`, { tasks }).then((r) => { invalidateCachePrefix('tasks'); return r; }),
