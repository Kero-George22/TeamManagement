...
export default function Login() {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      toast.success('Welcome back, ' + (data.user?.username || 'Hero') + '!');
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="portal-wrap grid-bg">
      <div className="portal-box fade-up">
        <div className="portal-logo">
          ...
          <div className="portal-title">JOBXP</div>
          <div className="portal-sub">SIGN IN TO THE ARENA</div>
        </div>
        ...
        <div style={{ display:'flex', justifyContent:'space-between', marginTop:8, fontFamily:'var(--font-mono)', fontSize:11 }}>
          <Link to="/forgot-password" style={{ color:'var(--text-2)' }}>Forgot password?</Link>
