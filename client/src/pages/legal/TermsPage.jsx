  ...
  return (
    <div style={{ padding: '40px', maxWidth: '800px', margin: '0 auto', background: 'var(--bg)' }}>
      ...
      <div style={{ marginTop: '32px' }}>
        ...
        <p>By accessing and using TeamForge, you accept and agree to be bound by the terms and provision of this agreement.</p>
        
        <h2 style={{ marginTop: '24px' }}>2. Description of Service</h2>
        <p>TeamForge provides team management and collaboration tools. We reserve the right to modify or discontinue, temporarily or permanently, the service with or without notice.</p>
